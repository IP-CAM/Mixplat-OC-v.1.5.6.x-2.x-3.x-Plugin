...
class ControllerExtensionPaymentmixplat extends Controller {
    ...
    public function index($payname = array('name' => 'mixplat')) {
        ...
        if ($this->config->get($pname . '_instruction_attach')) {
            ...
            $data['mixplati']         = $this->model_extension_payment_mixplat->getCustomFields($order_info, $this->config->get($pname . '_instruction_' . $this->config->get('config_language_id')));
        }
    ...
    public function confirm($payname = array('name' => 'mixplat')) {
        ...
        if (strpos($this->session->data['payment_method']['code'], 'mixplat') !== false) {
            ...
            if ($this->config->get($pname . '_mail_instruction_attach')) {
                ...
                $instroz = $this->model_extension_payment_mixplat->getCustomFields($order_info, $this->config->get($pname . '_mail_instruction_' . $this->config->get('config_language_id')));
    ...
    public function callback() {
        ...
        if ($this->config->get($order_info['payment_code'] . '_createorder_or_notcreate') && $order_info['order_status_id'] != $this->config->get($order_info['payment_code'] . '_on_status_id')) {
            ...
            if (!$this->config->get($order_info['payment_code'] . '_mail_instruction_attach')) {
                ...
                $comment .= $this->model_extension_payment_mixplat->getCustomFields($order_info, $this->config->get($order_info['payment_code'] . '_mail_instruction_' . $order_info['language_id']));
            ...
            if (!$this->config->get($order_info['payment_code'] . '_success_alert_customer')) {
                if ($this->config->get($order_info['payment_code'] . '_success_comment_attach')) {
                    $message = $this->model_extension_payment_mixplat->getCustomFields($order_info, $this->config->get($order_info['payment_code'] . '_success_comment_' . $order_info['language_id']));
    ...
    public function go() {
        ...
        if ($paystat['status'] == 0) {
            ...
            if ($this->config->get($order_info['payment_code'] . '_hrefpage_text_attach')) {
                $data['send_text'] = $this->model_extension_payment_mixplat->getCustomFields($order_info, $this->config->get($order_info['payment_code'] . '_hrefpage_text_' . $this->config->get('config_language_id')));
            } else {
    ...
    private function getReceipt($order_info, $totalcheck) {
        ...
        if ($this->config->get($order_info['payment_code'] . '_tax_system_code') == 1 && $this->config->get($order_info['payment_code'] . '_shipping_tax')) {
            $ndsship = $this->model_extension_payment_mixplat->getndscode($this->config->get($order_info['payment_code'] . '_shipping_tax'));
        }
        ...
        if ($this->config->get($order_info['payment_code'] . '_tax_system_code') == 1 && $this->config->get($order_info['payment_code'] . '_nds_important')) {
            $ndsval = $this->model_extension_payment_mixplat->getndscode($this->config->get($order_info['payment_code'] . '_nds_important'));
        }
    ...
    public function fail() {
        ...
        if ($this->config->get($order_info['payment_code'] . '_fail_page_text_attach')) {
            ...
            $data['fail_text'] .= htmlspecialchars_decode($this->model_extension_payment_mixplat->getCustomFields($order_info, $this->config->get($order_info['payment_code'] . '_fail_page_text_' . $this->config->get('config_language_id')), $order_info['payment_code']));
        } else {
